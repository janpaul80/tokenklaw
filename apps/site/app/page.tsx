...
const runtimes = [
  ...
  { name: "OpenCode", status: "✅ Validated", detail: "SKILL.md loaded; content visible via opencode debug skill." },
  { name: "Codex", status: "Scaffolded", detail: "MCP server registered; tool calls require interactive session." },
